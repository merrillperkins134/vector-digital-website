      ...
      <Disclosure as="nav" className="sticky top-0 z-50 bg-[#0d1b2a] border-b border-[rgba(42,122,245,0.18)]">
          ...
          <div className="flex h-20 items-center justify-between">
            ...
            <div className="hidden md:flex items-center">
              <a
                ...
                className="bg-[#2a7af5] hover:bg-[#1a66e0] text-white px-5 py-2.5 rounded-md text-sm font-semibold transition-colors whitespace-nowrap"
              >
                Book a Call
              </a>
            </div>
        ...
        <DisclosurePanel className="md:hidden border-t border-[rgba(42,122,245,0.18)]">
          <div className="space-y-1 px-3 pt-3 pb-4">
            ...
            <a
              href="https://cal.com/kmperkins85/vector-digital"
              className="block mt-2 bg-[#2a7af5] hover:bg-[#1a66e0] text-white px-4 py-2.5 rounded-md text-base font-semibold transition-colors text-center"
            >
              Book a Call
            </a>
          </div>
